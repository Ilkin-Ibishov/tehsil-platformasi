...
check("physics leak qaydası core-dadır", physics.system.includes("Sızma qadağası"), true)
check("math leak qaydası core-dadır", fallback.system.includes("Sızma qadağası"), true);
